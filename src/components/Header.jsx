...
class Header extends Component {
  render() {
    ...
    return (
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between pl-2.5 pr-6 py-2 bg-black">
        ...
        <div className="flex justify-center items-center gap-3.5 lg:gap-4">
          <Search className="lg:hidden cu-item" />
          <div className="flex justify-center items-center navbar-item cu-item">
            <Plus />
            <p className="p-0">Create</p>
          </div>
